...
public class PrintTicket1 extends JFrame
{
	public PrintTicket1(String sFrom, String sTo, String sClass, Integer iAdult, Integer iChildren, Integer iInfant, String sBookingDate, Integer iPrice, String sTime)
	{
		...
		JLabel LRohan=new JLabel("<html><I><font color=\"#8FBC8F\">Rohan Kumar</font></I></html>");
		JLabel LBhawesh=new JLabel("<html><I><font color=\"#8FBC8F\">Bhawesh bhaskar</font></I></html>");
		JLabel LAmit=new JLabel("<html><I><font color=\"#8FBC8F\">Amit</font></I></html>");
		...
		LRohan.setBounds(285,485,300,20);
		LBhawesh.setBounds(285,505,300,20);
		LAmit.setBounds(285,525,300,20);
